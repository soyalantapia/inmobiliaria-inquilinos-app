        ...
        <section className="space-y-3">
          ...
          <Card className="divide-y">
            ...
            <LinkRow
              ...
              href="/documentos"
            />
            {/* `/calendario` y `/profesionales` son carteles de «Disponible pronto» en
                producción: las dos pantallas se gatean con `if (apiEnabled) return <Proximamente
                …>` porque se arman con mocks. Las filas NO se sacan —la capacidad está en camino
                y esconderla no ayuda— pero sí dicen que todavía no anda. Sin el badge se leen
                como algo que funciona, y la descripción de profesionales llegaba a prometer
                técnicos «verificados».

                El tour de onboarding tenía este mismo defecto y se cerró en #154; esto es la
                pantalla de al lado, que quedó afuera de esa pasada. */}
            <LinkRow
