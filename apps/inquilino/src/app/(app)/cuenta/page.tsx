        ...
        <section className="space-y-3">
          ...
          <Card className="divide-y">
            ...
            {/* `/calendario` y `/profesionales` son carteles de «Disponible pronto» en
                producción (los dos se gatean con `if (apiEnabled) return <Proximamente …>`).
                Las filas no se sacan —la capacidad está en el camino y esconderla no ayuda—
                pero SÍ dicen que todavía no anda: sin el badge se leen como algo que funciona,
                y la descripción de profesionales llegaba a prometer técnicos «verificados». */}
            <LinkRow
