...
export async function seedOperacion(prisma: PrismaClient, tid: string) {
  ...
  const profesionales = [
    ...
    { id: 'prof_005', nombre: 'Camila Torres', categoria: 'PINTOR' as const, zona: 'Palermo, Belgrano', telefono: '+54 9 11 4488 1107', email: 'camila.t@example.com', rating: 4.5, cantTrabajos: 9, ultimoTrabajo: '2026-01-18', verificado: false, notas: 'Especializada en interiores', activo: true },
    { id: 'prof_006', nombre: 'Frío Pro AA', categoria: 'TECNICO_AC' as const, zona: 'CABA', telefono: '+54 9 11 6678 9921', email: 'contacto@friopro.example.com', rating: 4.7, cantTrabajos: 22, ultimoTrabajo: '2026-04-12', verificado: true, notas: 'Service split y central', activo: true },
