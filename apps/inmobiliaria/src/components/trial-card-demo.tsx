...
/**
 * Card del trial gratuito que vive DENTRO de /configuracion (sección de
 * facturación). Es la versión DEMO: lee/escribe el trial desde localStorage
 * (trial-storage) e incluye un toggle para activarlo a mano sin backend.
 *
 * La barra superior full-width cableada al /auth/me real vive en
 * `trial-banner.tsx` (TrialBanner). Acá conservamos la UX demo de siempre.
 */
export function TrialCardDemo() {
