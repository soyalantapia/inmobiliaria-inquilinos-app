...
function Semana() {
  // ⚠️ La copy de estos pares es la de `main`, NO la que traía la rama de la landing.
  // Esa rama es de julio y venía con «El ajuste por índice se aplica solo, sin tocar Excel»,
  // que el 02/09 se sacó a propósito de todas las superficies públicas (9b93f549: «sacar de
  // las superficies públicas todo lo que el sistema no hace»). El sistema AVISA cuándo toca
  // el ajuste; no lo aplica solo. Mergear la rama tal cual habría revivido la promesa vieja
  // adentro de un cambio que decía ser sólo de maquetado.
  ...
  const PARES = [
    ...
    { antes: 'Los ajustes por ICL quedan desactualizados entre contratos.', despues: 'Te avisa cuándo toca el ajuste, cargás el monto nuevo y recalcula las cuotas.' },
